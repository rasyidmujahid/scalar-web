            ...
            <div id="form_hide<?php echo $cs_counter_node;?>">
                ...
                ?>" novalidate>   
                    ...
                    <p class="comment-form-author">
                        <label><?php _e('Name', 'WeStand'); ?><span><?php  _e('(required)','WeStand'); ?></span></label>
                    ...
                    <p class="comment-form-email">
                        <label><?php _e('Email', 'WeStand'); ?><span><?php  _e('(required)','WeStand'); ?></span></label>
                        <span class="icon-input">
                    ...
                    <p class="comment-form-contact">
                        <label><?php if($cs_theme_option['trans_switcher']== "on"){ _e('Subject','WeStand');}else{ echo $cs_theme_option['trans_subject']; } ?><span><?php   _e('(required)','WeStand'); ?></span></label>
                        <span class="icon-input">
                    ...
                    <p class="comment-form-comment">
                        <label><?php if($cs_theme_option['trans_switcher']== "on"){ _e('Message','WeStand');}else{echo $cs_theme_option['trans_message']; ?><span><?php   _e('(required)','WeStand');} ?></span></label>
                    ...
                    <p class="form-submit">
                        ...
                        <input type="submit" value="submit" name="" id="submit_btn<?php echo $cs_counter_node ?>"><?php _e('', 'WeStand'); ?></input>
