                          ...
                          <div class="col-left">
                            <div class="element_size_100">
                                <div class="contant-info">
                                  ...
                                  <?php if($image_url <> ''){?>
                                        <figure><a><img src="<?php echo $image_url;?>" alt=""></a></figure>
                                   <?php }?>
                                    <div class="text">
                                        <?php
                                             if($cs_xmlObject->var_cp_expertise <> ''){
                                                  echo '<h5><a>'.$cs_xmlObject->var_cp_expertise.'</a></h5>';
                                             }
                                             if($cs_xmlObject->var_cp_email <> ''){
                                                  echo '<span><a href="mailto:'.$cs_xmlObject->var_cp_email.'">'.$cs_xmlObject->var_cp_email.'</a></span>';
                                             }
                                        ?>
                                        <div class="followus">
                                             <?php if($cs_xmlObject->facebook <> ''){?><a href="<?php echo $cs_xmlObject->facebook;?>" target="_blank"><i class="fa fa-facebook-square"></i></a><?php }?>
                                            <?php if($cs_xmlObject->twitter <> ''){?><a href="<?php echo $cs_xmlObject->twitter;?>" target="_blank"><i class="fa fa-twitter"></i></a><?php }?>
                                            <?php if($cs_xmlObject->linkedin <> ''){?><a href="<?php echo $cs_xmlObject->linkedin;?>" target="_blank"><i class="fa fa-instagram"></i></a><?php }?>
                                            <?php if($cs_xmlObject->google_plus <> ''){?><a href="<?php echo $cs_xmlObject->google_plus;?>" target="_blank"><i class="fa fa-google-plus"></i></a><?php }?>
                                        </div>
                                </div>
                                </article>
                                    <ul>
                                    <?php foreach($cs_xmlObject->social as $social){?>
                                        <li>
                                            <?php if($social->var_cp_image_url <> ''){?> <i class="fa <?php echo $social->var_cp_image_url;?>"></i><?php }?>
                                            <p>
                                                <?php if($social->var_cp_title <> ''){?><strong><?php echo $social->var_cp_title;?></strong><br/><?php }?>
                                                <?php if($social->var_cp_team_text <> ''){echo $social->var_cp_team_text;}?>
                                            </p>
                                        </li>
                                     <?php }?>
