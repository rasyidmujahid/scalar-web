                      ...
                      <?php } else if($event_thumb_view == 'Map' && $cs_event_meta->event_address <> ''){?>
                                ...
                                <?php if($cs_event_meta->event_address <> "" && $event_loc_lat <> "" && $event_loc_long <>"" && $event_loc_zoom <> ''){ ?>
										...
										jQuery(document).ready(function(){
											event_map("<?php echo 'Cambridgeshire'.'<br>'.$loc_city.'<br>'.$loc_postcode.'<br>'.$loc_country  ?>",<?php echo $event_loc_lat ?>, <?php echo $event_loc_long ?>,<?php echo $event_loc_zoom ?>,<?php echo $post->ID; ?>);
										});
										</script>
